...
Shader "Custom/Ripples" {
	Properties {
		...
		_FrequencyImpacts ("FrequencyImpacts", float) = 1
		_WaveAmplitude1 ("_WaveAmplitude1", float) = 1
		_WaveAmplitude2 ("_WaveAmplitude2", float) = 1
		_WaveAmplitude3 ("_WaveAmplitude3", float) = 0
		_WaveAmplitude4 ("_WaveAmplitude4", float) = 0
		_WaveAmplitude5 ("_WaveAmplitude5", float) = 0
		_WaveAmplitude6 ("_WaveAmplitude6", float) = 0
		_WaveAmplitude7 ("_WaveAmplitude7", float) = 0
		_WaveAmplitude8 ("_WaveAmplitude8", float) = 0
	...
	SubShader {
		...
		sampler2D _MainTex;
		float _Scale, _Speed, _Frequency, _FrequencyImpacts;
		...
		UNITY_INITIALIZE_OUTPUT(Input,o);
		    ...
		    half value1 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX1) + (v.vertex.z * _OffsetZ1)) );
		    half value2 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX2) + (v.vertex.z * _OffsetZ2)) );
		    half value3 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX3) + (v.vertex.z * _OffsetZ3)) );
		    half value4 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX4) + (v.vertex.z * _OffsetZ4)) );
		    half value5 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX5) + (v.vertex.z * _OffsetZ5)) );
		    half value6 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX6) + (v.vertex.z * _OffsetZ6)) );
		    half value7 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX7) + (v.vertex.z * _OffsetZ7)) );
		    half value8 = _Scale * sin(_Time.w * _Speed + _FrequencyImpacts * (offsetvert + (v.vertex.x * _OffsetX8) + (v.vertex.z * _OffsetZ8)) );
